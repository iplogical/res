...
(
	...
	note varchar(255),
	number integer
		constraint uk_tn0xh3e1kf46b9ty21j6fwyvn
			unique
	...
	restaurant_id bigint not null
		constraint fkdrhghxnv4me7g5qiyivfmn91y
...
(
	...
	version bigint,
	name varchar(255) not null
		constraint uk_h3uy8nfdnki1df8pecwojbos6
			unique,
	ordernumber integer not null,
	status varchar(255) not null,
	type varchar(255),
...
(
	...
	children bigint not null
		constraint uk_1shxuw3uccwr2hwmo9wr9jctx
			unique
		constraint fk1tfpiiu01j2my5jevmo3vaehc
			references product_category
);
...
(
	...
	table_id bigint not null
		constraint fkjkag406of33ikpyrv8vjr1lir
			references "_table",
...
(
	...
	type varchar(255) not null,
	receipt_id bigint not null
		constraint fkvthd95w2rjv66iwds7w1ab9e
			references receipt,
	product_id bigint,
...
(
	...
	created timestamp,
	receipt_record_id bigint not null
		constraint fkaxsef3tmvt3799879atwlh8cf
...
(
	...
	component_product_id bigint not null
		constraint fkaeklljcl0owvnhbybr8h43dr4
			references product,
	product_id bigint not null
		constraint fk6v57gfytje5fej73nc457nhkk
			references product
);
...
(
	...
	tablenumber integer not null
		constraint reservation_tablenumber_check
			check (tablenumber >= 1),
	table_id bigint
		constraint fkesrwfn4ew8ui4oudy1vrjhtyr
			references "_table"
);
...
(
	...
	soldquantity double precision not null,
	product_id bigint not null
		constraint fkocjxt3jri1ivtm9quhmj6h33i
			references product
);
...
(
	...
	status varchar(255) not null,
	vat_serie_id bigint not null
		constraint fk21s4deulwdjcp7tqaegygp4mf
...
alter table vat_serie owner to postgres;
