...
public class JavaFXIds {
    ...
    public final static String TABLEFORM_GUEST_COUNT = "#guestCount";
    public final static String TABLEFORM_CAPACITY = "#tableCapacity";
    public final static String TABLEFORM_NOTE = "#tableNote";
    public final static String TABLEFORM_WIDTH = "#width";
    public final static String TABLEFORM_HEIGHT = "#height";
    public final static String TABLEFORM_CONFIRM = "#confirm";
    public final static String TABLEFORM_CANCEL = "#cancel";
