...
public class NameUtils {
    ...
    public static final String AGGREGATE_TOP_ONE = "aggregateTopOne";

    public static final String FOOD = "Étlap";
    public static final String AGGREGATE_TOP_TWO = "aggregateTopTwo";

    public static final String COCKTAILS = "Koktélok";
    public static final String LEAF_FIVE = "leafFive";

    public static final String BEERS = "Sörök";
    public static final String AGGREGATE_ONE = "aggregateOne";

    public static final String TAP_BEER = "Csapolt";
    public static final String LEAF_ONE = "leafOne";

    public static final String BOTTLE_BEER = "Üveges";
    public static final String LEAF_THREE = "leafThree";

    public static final String BACK = "Vissza";

    public static final String FOODS = "Ételek";
    public static final String AGGREGATE_FOUR = "aggregateFour";

    public static final String WINE = "Borok";
    public static final String AGGREGATE_TWO = "aggregateTwo";
    public static final String LEAF_TWO = "leafTwo";

    public static final String SOPRONI = "Sop 0,5L";
    public static final String SOPRONI_LONG = "Soproni 0,5L";
    ...
    public static final String KRUSO_RAPID_CODE = "13";
    public static final String KRUSO_LONG = "Krusovice Svetlé";
    public static final String PRODUCT_TWO = "product2";
    public static final String PRODUCT_TWO_LONG = "productTwo";
    public static final String PRODUCT_TWO_RAPID_CODE = "12";
    ...
    public static final String GAME_FEE = "Játékdíj";
}
